...
const Licenses = () => {
    ...
    //const { licenses } = useContext(LicenseContext);
    ...
    const editLicense = (c: App.License) => {

        navigate('/license/' + c.id );
        
    };

    const confirmDelete = (cust: App.License) => {
        setLicense(cust);
    ...
    const actionBodyTemplate = (rowData: App.License) => {
        return (
    ...
    const nameBodyTemplate = (rowData: App.License) => {
        return (
            <>
